...
It can be seen that all maps constructed by cartographer are biased. However, our method can improve SLAM's performance in degraded environments by using the degradation optimization module, so as to build more accurate environment maps and improve positioning accuracy. Please see supplementary.pdf for detailed quantitative analysis.
